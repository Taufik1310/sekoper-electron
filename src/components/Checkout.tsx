        ...
        <div className="flex mt-20">
            ...
            <div className="w-6/12">
                ...
                <form className="mb-10">
                    ...
                    <input type="text" name="quantity" id="quantity" className="bg-transparent border border-zinc-400 font-semibold w-12 text-center outline-blue-700" defaultValue={quantity} value={quantity} onInput={(e: ChangeEvent<HTMLInputElement>) => handleQuantityChanged(e.target.value)} />
                ...
                <button type="button" className="bg-blue-700 px-8 py-3 text-blue-50 font-semibold text-sm">Beli Sekarang</button>
            </div>
        </div>
    )
}
